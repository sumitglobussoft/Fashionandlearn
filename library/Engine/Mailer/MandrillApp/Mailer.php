...
//Prevent any copy of this object
    ...
    public function sendtemplate(){
       ...
       if(func_num_args() >= 5){  
        ...
        $message = array(
            ...
            'text' => null,
            'subject' => $subject,
            'from_email' =>'support@fashiontuts.com',
            'from_name' =>'Fashiontuts Support',
            'to' => array(
                array(
                    'email' => $email,
                    'name' => $username
            ...
            'headers' => array('Reply-To' => 'support@fashiontuts.com'),
            'important' => false,
            'track_opens' => null,
            'track_clicks' => null,
            'auto_text' => null,
     ...
     * Name: ABhishek M
     * 
     * Description: This function accepts six mail related parameters and uses 
     *              them to send mail to provided email address using specified 
     *              template.
     */
    public function sendtemplates(){
       ...
       if(func_num_args() >= 6){  
        ...
        $message = array(
            ...
            'from_name' =>'Fashionlearn Support',
            'to' => array(
                array(
                    'email' => $email,
                    'name' => $username
    ...
    /*Name: Namrata Singh
     * Date: 09/01/2015
     * Description: The function takes parameters and used to send the mail
     *              when user wants to refer a friend.
     */
    
    public function refertemplate(){
      
       if(func_num_args() >= 5){  
        
           $template_name = func_get_arg(0);
           $email = func_get_arg(1);
           $useremail = func_get_arg(2);
//           $username = func_get_arg(3);
           $subject = func_get_arg(3);
           $mergevars = func_get_arg(4);
//        print_r($template_name) ;    print_r($email) ; print_r($useremail);print_r($subject);  print_r($mergevars); die;
        try {
        $message = array(
            'html' => null,
            'text' => null,
           ...
           // 'from_name' =>$username,
            ...
            'headers' => array('Reply-To' => $useremail),
            'important' => false,
            'track_opens' => null,
            'track_clicks' => null,
            'auto_text' => null,
        ...
        $async = false;
      $result = $this->objMandrill->messages->referTemplate($template_name, null, $message, $async);

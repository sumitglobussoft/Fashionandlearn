...
//        print_r($access_token); die;
   ...
   return $this->request(self::ACCESS_TOKEN_ENDPOINT, array(
     ...
     */
    public function clientCredentials($scope = array('public','upload','edit','delete','interact')) {
        if (is_array($scope)) {
            $scope = implode(' ', $scope);
        }
     ...
     * @return string
     */
    public function buildAuthorizationEndpoint($redirect_uri, $scope = array('public','upload','edit','delete','interact'), $state = 'uniquevimeo123') {
